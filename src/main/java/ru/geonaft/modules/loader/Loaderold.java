...
public class Loaderold extends Base implements OpenModule {
    ...
    public Loaderold(WindowsDriver<RemoteWebElement> driver) {
        super(driver);
        this.ribbon = new BaseRibbon(driver);
        this.workSpace = new BaseWorkSpaceAndEditor(driver);
        this.treeProjectOld = new TreeProjectOld(driver);
    ...
    public Loaderold doPreview(SubFolderSelector entity) {
        switch (entity) {
            case LOG:
    ...
    public Loaderold renameFieldPreview(SubFolderSelector entity) {
        switch (entity) {
            case TRAJECTORY:
                driver
    ...
    public Loaderold loadFileFromWindow(String from, String fileName) {
    ...
    public Loaderold loadFileToProject() {
    ...
    public Loaderold loadEntity(String from, String fileName, SubFolderSelector what) {
    ...
    @Step("Uploading to the project - {what}")
    public Loaderold loadEntityWithRename(String from, String fileName, SubFolderSelector what) {
        loadFileFromWindow(from, fileName);
    ...
    public Loaderold clickRandomCheckBox() {
    ...
    public Loaderold openEditorLoadedFile(SubFolderSelector what) {
    ...
    public Loaderold checkDataInEditor(NameEntityToProject entity) {
        workSpace
    ...
    public Loaderold checkDataFolder(SubFolderSelector subFolder) {
    ...
    public Loaderold doMultiFilePreview(SubFolderSelector entity) {
        switch (entity) {
            case SURFACE:
                fileNameList =
    ...
    public Loaderold multiFileLoad(String from, SubFolderSelector what) {
        loaderWindow.findElementByName(openFileButtonSelector).click();
