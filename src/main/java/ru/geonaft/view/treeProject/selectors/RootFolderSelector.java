...
public enum RootFolderSelector {
    ...
    MODULES("Geosteering.UI.Controls.DataTreeView.DataTree.ModulesTreeViewItem"),
    TEMPLATES("Geosteering.UI.Controls.DataTreeView.PropertiesTemplates.TemplatesTreeViewItem"),
    ;
